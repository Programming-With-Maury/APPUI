...
from ..app_runtime import get_current_session
...
def vstack(
    children: Iterable[UINode], gap: int = 8, align: str = "start", justify: str = "start"
) -> UINode:
    return UINode(
        id=_new_id(),
        type="VStack",
...
def hstack(
    children: Iterable[UINode], gap: int = 8, align: str = "center", justify: str = "start"
) -> UINode:
    return UINode(
        id=_new_id(),
        type="HStack",
...
def input_text(
    ...
    node = UINode(
        ...
        props={
            ...
            "events": {"change": on_change is not None},
        },
        children=[],
    )
